...
export default function LoginPage() {
  ...
  const handleMagicLinkLogin = async (e: React.FormEvent) => {
    ...
    try {
      await authMethods.sendMagicLink(email)
        ...
        <div className="glass rounded-xl p-8 max-w-md w-full">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-6">
              We've sent a secure login link to <span className="text-neon-turquoise">{email}</span>
            </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center p-4">
      <div className="glass rounded-xl p-8 max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Sign in to your MomentumX Dashboard</p>
        </div>
          ...
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4 mb-6">
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm text-blue-300">
                <p className="font-medium mb-1">Secure Passwordless Login</p>
                <p>We'll send you a secure link that expires in 15 minutes. No password needed!</p>
              </div>
            </div>
          </div>
        )}
        ...
        {/* Submit Button */}
        <button
          onClick={authMode === 'password' ? handlePasswordLogin : handleMagicLinkLogin}
        ...
        {authMode === 'password' && (
          <div className="mt-6 text-center">
            <button
              ...
              className="text-neon-turquoise hover:text-neon-green text-sm transition-colors disabled:opacity-50"
            >
